...
def test_performance(
    ...
    """The function takes a negligible amount of time (less than 0.02 seconds).

    According to [Usability Engineering](https://www.nngroup.com/articles/response-times-3-important-limits/),
    less than 0.1 seconds feels instantaneous, so less than 0.02 seconds is
    ...
    for some reason.
    """
    negligible_time = 0.02 if "CI" not in os.environ else 10
    repeats = 10
